...
{
    public partial class Prodaja : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                zadnjeDodani.DataSource = DANekretnine.getZadnjeDodaneProdaja();
        ...
        {
            zadnjeDodani.DataSource = DANekretnine.getProdaja( Convert.ToInt32(ddlKantoni.SelectedValue), Convert.ToInt32(ddlKategorije.SelectedValue),
