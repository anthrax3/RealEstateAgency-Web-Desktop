<%@ Page Title="" Language="C#" MasterPageFile="~/MasterStranica.Master" AutoEventWireup="true" CodeBehind="Prodaja.aspx.cs" Inherits="ProdajaNekretnina.Prodaja" %>
     ...
     <section id="content">
        <div class="container_12">
            <div class="grid_8">
                ...
                <div >
                    <div>
                        <asp:DataList runat="server" ID="zadnjeDodani" RepeatDirection="Horizontal" Width="100%" RepeatColumns="2">
                            <ItemTemplate>
                ...
                <div class="left-1">
                    ...
                    <div id="form-1" class="form-1 bot-1">
                        ...
                        <div class="select-2">
                            ...
                            <asp:TextBox ID="tbCijena" runat="server" placeholder="20000"></asp:TextBox>
                        </div>
                        <div class="select-2 last">
                            <label>Cijena DO</label>
                            <asp:TextBox ID="tbCiejnaDO" runat="server" placeholder="40000"></asp:TextBox>
                        </div>
